    ...
    <!--News block-->
    <section class="content1 cid-srPN4fVE3X news-collection" id="">
        <div class="container">
        ...
        <nav aria-label="...">
            <ul class="pagination pagination-md">
                <li class="page-item disabled">
                    <a class="page-link" href="<?= base_url('news/') ?>" tabindex="1">Previous</a>
                </li>
                <?php if ($stop == 1): ?>
                    <li class="page-item active"><a class="page-link" href="<?= base_url('news/') ?>">1</a></li>
                    
                    <li class="page-item disabled"><a class="page-link" href="<?= base_url('news/page/2') ?>">Next</a></li>
                <?php endif ?>
                <?php if ($stop == 2): ?>
                    <li class="page-item active"><a class="page-link" href="<?= base_url('news/') ?>">1</a></li>
                    <li class="page-item"><a class="page-link" href="<?= base_url('news/page/2') ?>">2 <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="page-item disabled"><a class="page-link" href="<?= base_url('news/page/3') ?>">3</a></li>
                    <li class="page-item">
