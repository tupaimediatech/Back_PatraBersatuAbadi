                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item <?= $title == 'Berita' ? 'active' : '' ?>">
                                    <a href="<?= base_url() ?>admin/berita/"><i class="ik ik-file-text"></i><span>Berita</span></a>
                                </div>
                                <div class="nav-item <?= $title == 'Testimoni' ? 'active' : '' ?>">
                                    <a href="<?= base_url() ?>admin/testimoni/"><i class="ik ik-award"></i></i><span>Testimoni</span></a>
                                </div>
                                <div class="nav-item">
